      ...
      <div class="board">
        <table width="100%">
            ...
            <tr>
                ...
                <td><input  type="text" name="nama-lengkap" id="" placeholder="Alamat" value="Kediri"></td>
            </tr>
            <tr>
                <td><label for="">Telepon</label></td>
                <td><input type="text" name="nama-lengkap" id="" placeholder="Telepon" value="088880088880"></td>
            </tr>
