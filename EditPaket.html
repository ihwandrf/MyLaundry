...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="editpaket.css" />
  ...
  <body>
    ...
    <section id="interface">
      ...
      <div class="i-name-p">
      <h3 class="i-name">Edit Paket Laundry</h3>
      <p id="p-wajib">*Semua isian wajib diisi, kecuali data yang tidak bisa diganti</p>
    </div>
      <div class="board">
        <table width="100%">
          <tr>
            <td><label for="">No paket</label></td>
            <td><select class="stdr-btn unavailable" name="no-paket" id="" disabled>
              <option value="1">1</option>
            </select>
            </td>
        </tr>
        <tr>
          <td><label for="">Nama Paket</label></td>
          <td><input type="text" name="nama-paket" id="" placeholder="Nama Paket" value="Cuci"></td>
      </tr>

        <tr>
          <td><label for="">Harga/kg</label></td>
          <td><input type="text" name="harga" id="" placeholder="Harga per kg" value="Rp3.000"></td>
      </tr>
