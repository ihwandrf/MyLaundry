...
<html lang="en">
  ...
  <body>
    ...
    <section id="interface">
      ...
      <div class="i-name-p">
      <h3 class="i-name">Tambah Karyawan</h3>
      ...
      <div class="board">
        <table width="100%">
          <tr>
            ...
            <td><input type="text" name="nama-lengkap" id="" placeholder="Username"></td>
        </tr>
        <tr>
          <td><label for="">Password</label></td>
          <td><input type="text" name="nama-lengkap" id="" placeholder="Password"></td>
      </tr>
      <tr>
        ...
        <td><input type="email" name="email" id="" placeholder="Email"></td>
            ...
            <tr>
                ...
                <td><input  type="text" name="nama-lengkap" id="" placeholder="Alamat" ></td>
            </tr>
            <tr>
                <td><label for="">Telepon</label></td>
                <td><input type="text" name="nama-lengkap" id="" placeholder="Telepon"></td>
            </tr>
