...
<html lang="en">
  ...
  <body>
    ...
    <section id="interface">
      ...
      <div class="i-name-p">
      <h3 class="i-name">Tambah Paket</h3>
      ...
      <div class="board">
        ...
        <tr>
          ...
          <td><input type="text" name="nama-paket" id="" placeholder="Nama Paket"></td>
      </tr>

        <tr>
          <td><label for="">Harga/kg</label></td>
          <td><input type="text" name="harga" id="" placeholder="Harga per kg"></td>
      </tr>
