...
<html lang="en">
  ...
  <body>
    ...
    <section id="interface">
      ...
      <div class="i-name-p">
      <h3 class="i-name">Tambah Transaksi</h3>
      <p id="p-wajib">*Semua isian wajib diisi, kecuali data yang tidak bisa diganti</p>
    </div>
      <!-- <div class="values">
        <div class="val-box">
      ...
      <div class="board">
        <table width="100%">
          <tr>
            <td><label for="">No Order</label></td>
            <td><select class="stdr-btn unavailable" name="" id="" disabled>
              <option value="124">124</option>
            </select>
            </td>
        </tr>
        <tr>
          <td><label for="">ID Customer</label></td>
          <td><input type="text" name="id" id="" placeholder="ID Customer"></td>
      </tr>
          <!-- <tr>
            <td><label for="">Nama Customer</label></td>
            <td><select class="stdr-btn" name="" id="" >
              <option value="-">- Pilih Nama Customer -</option>
              <option value="Nabil Najmudin">Nabil Najmudin</option>
              <option value="Jennie Kim">Jennie Kim</option>
            </select></td>
        </tr> -->
        <tr>
          <td><label for="">Status Pembayaran</label></td>
          <td><select class="stdr-btn" name="status-bayar" id="" >
      ...
      <tr>
        ...
        <td><select class="stdr-btn" name="status-pesanan" id="" >
        ...
        <tr>
          <td><label for="">Berat (kg)</label></td>
          <td><input type="text" name="berat" id="" placeholder="Berat (kg)"></td>
      </tr>
      ...
      <!-- <tr>
        ...
        <td><input type="email" name="email" id="" placeholder="Email"></td>
            ...
            <!-- <tr>
                ...
                <td><input type="text" name="nama-lengkap" id="" placeholder="Nama Lengkap"></td>
            </tr> -->
            <!-- <tr>
                <td><label for="">Alamat</label></td>
                <td><input  type="text" name="almaat" id="" placeholder="Alamat" ></td>
            </tr> -->
            <!-- <tr>
                <td><label for="">Telepon</label></td>
                <td><input type="text" name="telepon" id="" placeholder="Telepon"></td>
            </tr> -->
            <tr>
              <td><label for="">Tanggal Masuk</label></td>
              <td><input type="date" name="tgl-masuk" id="" placeholder="Tanggal Masuk"></td>
          </tr>
            <tr>
              <td><label for="">Tanggal Keluar</label></td>
              <td><input type="date" name="tgl-keluar" id="" placeholder="Tanggal Keluar"></td>
          </tr>
            <!-- <tr>
                <td><label for="">Email</label></td>
                <td><input type="email" name="email" id="" placeholder="Email"></td>
            ...
            <tr>
                <td></td>
                <td>
                <button type="button" class="btn btn-outline-primary active font-kecil aksi-btn">Submit</button>
                <button type="button" class="btn btn-outline-danger active font-kecil aksi-btn">Batal</button>
                </td>
            </tr>
