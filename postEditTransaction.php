...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE pesanan SET nama_pesanan = '$nama_pesanan' ,  tanggal_masuk_pesanan = '$tgl_masuk' , tanggal_keluar_pesanan = '$tgl_keluar', status_pesanan = $status_pesanan , berat_pesanan = $berat, jenis_paket = $jenis_paket, status_pembayaran = $status_bayar, id_customer = $id WHERE id_pesanan = $id_pesanan ;";
